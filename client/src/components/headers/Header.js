...
function Header() {
    ...
    // redirection vers interface admin (s'il utilisateur admin)
    const adminRouter = () => {
        return (
            <>
    ...
    return (
        <header>
            ...
            <div className="logo">
                ...
                <h1>
                    <Link to="/">{isAdmin ? 'Admin' : <img className='img1' src="/images/logo.png" alt="" />} </Link>
                </h1>
            </div>
